                ...
                Section::make('Contract Information')
                    ...
                    ->schema([
                        ...
                        Select::make('proponent')
                            ...
                            ->searchable()
                            ->live(),
                        Select::make('proponent_business_unit')
                            ->label('Proponent Business Unit')
                            ->options(function (Get $get) {
                                $proponentId = $get('proponent');
                                if (! $proponentId) {
                                    return [];
                                }
                                $proponent = ContractProponent::where('proponent_code', $proponentId)->first();
                            ...
                            ->searchable()
                            ->live(),
                        Select::make('proponent_department')
