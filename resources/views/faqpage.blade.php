...
<head>
    ...
    <title>{{ $currentDepartment->display_name }} - FAQ - I AM MIESCOR</title>
...
<body class="bg-white min-h-screen">
    <header class="fixed w-full top-0 z-50 bg-white transition-transform duration-300 shadow-md">
        <nav class="px-4 md:px-6 py-3 relative">
            <div class="flex justify-between items-center mx-auto max-w-screen-4xl relative"> <a href="/"
                    rel="noreferrer" class="flex items-center z-10">
            ...
            <div class="relative h-48 sm:h-56 md:h-64 lg:h-72 rounded-xl bg-linear-to-r from-orange-500 to-amber-400 overflow-hidden">
                <div class="absolute inset-0 flex flex-col justify-center p-6 sm:p-8 lg:p-12">
                    ...
                    <div class="mt-4 sm:mt-6">
                        <button type="button" class="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-[#111827] shadow-sm hover:bg-[#f9fafb] focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-orange-500 transition-colors">
                ...
                <section class="flex-1 min-w-0">
                                        ...
                                        @foreach($tagFaqs as $faq)
                                            <details class="group py-4" id="faq-{{ $faq->id }}">
                                                ...
                                                <div class="mt-3 pr-10 overflow-hidden">
                                                    <div class="faq-content text-sm text-[#374151] leading-relaxed">
                                                        {!! $faq->body !!}
                                                    </div>
                                                </div>
                                            </details>
                    ...
                    @else
                        ...
                        <div class="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <h3 class="text-lg font-medium text-[#111827] mb-2">No FAQs found</h3>
